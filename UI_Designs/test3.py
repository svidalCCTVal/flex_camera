...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Photo.setText("")
        self.Photo.setPixmap(QtGui.QPixmap("madera_inicial.JPG"))
        ...
        self.pushButton_Photo1.clicked.connect(self.show_photo1)
        self.pushButton_Photo2.clicked.connect(self.show_photo2)
